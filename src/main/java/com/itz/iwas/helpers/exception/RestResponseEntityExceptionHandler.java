package com.itz.iwas.helpers.exception;

import com.itz.iwas.helpers.common.calc.DateTimeCalc;
import com.itz.iwas.helpers.exception.custom.ResourceNotFoundException;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @NotNull
    @Override
    protected ResponseEntity<Object> handleHttpMessageNotReadable(@NotNull final HttpMessageNotReadableException ex, @NotNull final HttpHeaders headers, @NotNull final HttpStatus status, @NotNull final WebRequest request) {
        final String bodyOfResponse = "This should be application specific";
